        ...
        <div className="relative">
            ...
            <div className="relative group">
                <video
                    ...
                    playsInline
                    controls
                    className="rounded-3xl object-cover w-[600px] h-[435px] transition-all duration-300 group-hover:brightness-90"
                ...
                >
                    <div className="relative">
                        {/* Glow Effect - Yellow */}
                        <div className="absolute -inset-6 bg-yellow-400/40 rounded-full blur-xl animate-glow-slow -z-10"></div>
                        
                        {/* Outer Ring with Pulse Animation */}
                        <div className="absolute -inset-4 border-2 border-yellow-400/50 rounded-full animate-pulse-ring -z-5"></div>
                        
                        {/* Main Play Button */}
                        <div className="relative w-28 h-28 bg-[#1F3A34] rounded-full flex items-center justify-center cursor-pointer transform transition-all duration-300 hover:scale-110 hover:bg-[#2a4d45] shadow-2xl">
                            {/* Inner Glow */}
                            <div className="absolute inset-4 bg-yellow-400/20 rounded-full blur-sm"></div>
                            
                            {/* Play Icon */}
                            <svg
                                className="w-16 h-16 text-white ml-2 relative z-10"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                            ...
                            {/* Hover Effect Ring */}
                            <div className="absolute inset-0 border-4 border-transparent rounded-full transition-all duration-300 group-hover:border-yellow-400/30"></div>
                        </div>
                    </div>
                </div>
